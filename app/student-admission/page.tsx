...
import { Upload, FileText, GraduationCap, Users } from "lucide-react"
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input id="currentGrade" placeholder="Enter current grade" />
                  </div>
                  <div className="space-y-2">
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input id="parentPhone" placeholder="Enter phone number" required />
                  </div>
                  <div className="space-y-2">
                ...
                <div className="space-y-2">
                  ...
                  <Textarea id="address" placeholder="Enter complete home address" required />
                </div>
              </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <Card className="border-dashed border-2 border-primary/30 hover:border-primary/50 transition-colors">
                    <CardContent className="p-6 text-center">
                      ...
                      <p className="text-sm text-muted-foreground mb-4">Upload certified copy of birth certificate</p>
                  ...
                  <Card className="border-dashed border-2 border-primary/30 hover:border-primary/50 transition-colors">
                    <CardContent className="p-6 text-center">
                      ...
                      <p className="text-sm text-muted-foreground mb-4">Upload copy of parent/guardian ID</p>
                      <Button variant="outline" className="w-full bg-transparent">
                        <FileText className="w-4 h-4 mr-2" />
                        Choose File
                      </Button>
                  ...
                  <Card className="border-dashed border-2 border-primary/30 hover:border-primary/50 transition-colors">
                    <CardContent className="p-6 text-center">
                      ...
                      <p className="text-sm text-muted-foreground mb-4">
                        Upload recent utility bill or lease agreement
                      </p>
                      <Button variant="outline" className="w-full bg-transparent">
                        <FileText className="w-4 h-4 mr-2" />
                        Choose File
